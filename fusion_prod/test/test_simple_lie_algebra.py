...
class Test(unittest.TestCase):
    ...
    def testSL2OrbitIter(self):
        ...
        orbit_wt1 = cbd._Weight(liealg, [-1])
        orbit_wt2 = cbd._Weight(liealg, [1])
    ...
    def testSL2Tensor(self):
        ...
        dec_wt = cbd._Weight(liealg, [1])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
        self.assertEqual(1, decomp[dec_wt], "Tensor decomp incorrect")

        decomp = liealg.tensor([1], [1])
        dec_wt = cbd._Weight(liealg, [2])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
        self.assertEqual(1, decomp[dec_wt], "Tensor decomp incorrect")
        dec_wt = cbd._Weight(liealg, [0])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
        ...
        dec_wt = cbd._Weight(liealg, [7])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
        self.assertEqual(1, decomp[dec_wt], "Tensor decomp incorrect")
        dec_wt = cbd._Weight(liealg, [5])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
        self.assertEqual(1, decomp[dec_wt], "Tensor decomp incorrect")
        dec_wt = cbd._Weight(liealg, [3])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
    ...
    def testSL2MultiFusion(self):
        ...
        wt1 = cbd._Weight(liealg, [4])
        wt2 = cbd._Weight(liealg, [2])
        decomp = liealg.multi_fusion([wt2, wt2, wt2], 4)
        dec_wt = cbd._Weight(liealg, [4])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
        self.assertEqual(1, decomp[dec_wt], "Tensor decomp incorrect")
        dec_wt = cbd._Weight(liealg, [2])
        self.assertTrue(dec_wt in decomp, "Tensor decomp incorrect")
    ...
    def testDegree(self):
        ...
        wt2 = cbd._Weight(liealg, [3])
        wt3 = cbd._Weight(liealg, [5])
        ...
        wt1 = cbd._Weight(liealg, [0, 1, 0, 0])
